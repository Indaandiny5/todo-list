...
@section('content')
    <style>
        ...
        #content {
            background-image: url('{{ asset('images/Why I Like to Instagram the Sky.jpg') }}');
    ...
    <div id="content" class="overflow-y-hidden overflow-x-hidden">
        @if ($lists->count() == 0)
            <div class="d-flex flex-column align-items-center">
                ...
                <button type="button" class="btn btn-outline-primary btn-ig rounded-pill shadow-sm" data-bs-toggle="modal"
                    data-bs-target="#addListModal" style="width: fit-content;">
